...
def costs():
    ...
    columns = ("Harga Jual per kg", "Biaya Bibit", "Biaya Pakan", "Biaya Obat", "Biaya Perawatan", "Pendapatan", "Pengeluaran", "Laba/Rugi", "Saran Harga Jual")
    ...
    try:
        ...
        for i, line in enumerate(myresult):
            ...
            bibit = biaya_bibit * jumlah_lele
            kg_lele = jumlah_lele / 8
            jumlah_lele_hidup = 0.8 * jumlah_lele
            pendapatan = harga_jual_per_kg * jumlah_lele_hidup * kg_lele
            pengeluaran = bibit + biaya_pakan + biaya_obat + biaya_perawatan
...
icon_MyLele=ctk.CTkImage(Image.open("C:/Users/rhean/coba/mylele.png"), size=(30,30))
# JUDUL DAN BUTTON
judul=ctk.CTkLabel(head, text = '', image=icon_MyLele, bg_color="Light Blue", fg_color="Light Blue", text_color="white",font=("comic sans ms",15,"bold"))
